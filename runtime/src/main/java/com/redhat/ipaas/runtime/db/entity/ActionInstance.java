...
public class ActionInstance {
    ...
    private Long id;
    @Getter @Setter @ManyToOne @JoinColumn(name = "action_id")
    private Action action;
    @Getter @Setter @ManyToOne @JoinColumn(name = "configured_connector_id")
    private ConfiguredConnector configuredConnector;
    @OneToMany(fetch = FetchType.LAZY)
    private List<ActionInstanceProperty> actionInstanceProperties;
}
