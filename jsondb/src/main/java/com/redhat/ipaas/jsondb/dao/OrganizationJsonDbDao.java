...
import com.redhat.ipaas.dao.OrganizationDao;
...
public class OrganizationJsonDbDao extends JsonDbDao<Organization> implements OrganizationDao {

    @Autowired
    public OrganizationJsonDbDao(JsonDB jsondb) {
        super(jsondb);
    }
